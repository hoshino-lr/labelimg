...
from libs.net_detect import net_detect
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        self.net = net_detect("./resources/best.onnx")
        ...
        verify = action(get_str('verifyImg'), self.detect_by_net,
    ...
    def detect_by_net(self, _value=False):
        # 修改程序
        if self.default_save_dir is not None and len(ustr(self.default_save_dir)):
            if self.file_path:
                ...
                annotation_file_path = saved_path
            else:
                return False
        else:
            ...
            annotation_file_path = saved_path if self.label_file else self.save_file_dialog(remove_ext=False)
        img = self.qtpixmap_to_cvimg(self.image_data)
        shapes = self.net.update(img)
        ...
        try:
            ...
            self.error_message(u'Error saving label data', u'<b>%s</b>' % e)
            return False
        self.load_yolo_txt_by_filename(annotation_file_path)
        self.update_combo_box()
        return True
